...
class CustomPopup extends StatefulWidget {
  ...
  const CustomPopup({Key? key, required this.text, this.onProceed})
      : super(key: key);
              ...
              Text(
                ...
                style: TextStyle(
                  ...
                  color: popuptextcolor[
                      randomIndex], // Use the matching text color
                ),
              ),
              Align(
                  ...
                  children: [
                    ElevatedButton(
                      onPressed: () {
                        ...
                        _updateRandomIndex();
                        shuffledNoPointMessages =
                            shuffleMessages(nopointmessage);
                        showDialog(
                          context: context,
                      ...
                      style: ButtonStyle(
                        ...
                        side: WidgetStateProperty.all(const BorderSide(
                            width: 1, color: Color(0xffC26B93))),
                      ),
                    ...
                    ElevatedButton(
                      onPressed: () {
                        ...
                        setState(() {
                          playerScores[Globals.currentplayer] =
                              playerScores[Globals.currentplayer]! + 1;
                          Globals.playerActionCards[Globals.currentplayer]
                              ?.add(Globals.topactioncard);
                        });
                        Navigator.of(context).pop();
                        if (widget.onProceed != null) {
                          widget.onProceed!();
